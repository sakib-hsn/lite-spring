...
import com.sakib.io.models.dto.DeleteResponse;
import com.sakib.io.models.dto.LoginResponse;
...
public class AuthController {
    ...
    public LoginResponse login(@RequestParam("username") String username, @RequestParam("password") String password,
        ...
        if (user != null) {
            ...
            customSessionService.createSession(sessionId, username, response);
